...
function __process_authorization_header(request_params) {
    ...
    function __query_client_registrar(request_params) {
        return Q.Promise((resolve, reject) => {
            client_endpoint.client_registrar_module.get_client_registration(request_params.authorization_credentials.username)
                .then((client_account) => {
                    request_params.audience = request_params.authorization_credentials.username;
    ...
    function __query_user_account_registrar(request_params) {
        ...
        } else if ((request_params.username !== request_params.authorization_credentials.username) ||
            (request_params.password !== request_params.authorization_credentials.password)) {
            return Q.reject(new Error("Unauthorized request"));
        }

        return Q.Promise((resolve, reject) => {
            user_info_endpoint.user_account_registrar_module.get_user_account(request_params.authorization_credentials.username)
                .then((user_account) => {
...
function __send_token_for_password(request_params, request, reply) {
    ...
    __process_authorization_header(request_params)
        .then(() => {
            ...
            //the username attribute name is used in this implementaion.
            user_info_endpoint.user_account_registrar_module.get_user_account(request_params.username)
                .then((user_account) => {
                    if (user_account.password === request_params.password) {
