...
module.exports.register = function(server, oidc_options, next) {
    ...
    if (!oidc_options.configuration.client_endpoint.client_registrar_module) {
        ...
        try {
            ...
            if (typeof temp_var.encrypt_password !== "function") {
                return next(new Error("client_registrar_module specified in options does not export an encrypt_password() function!"));
            }
    ...
    if (!oidc_options.configuration.user_info_endpoint.user_account_registrar_module) {
        ...
        try {
            ...
            if (typeof temp_var.get_user_account_for_signin !== "function") {
                return next(new Error("user_account_registrar_module specified in options does not export a get_user_account_for_signin() function!"));
            }

            if (typeof temp_var.update_user_account_for_signout !== "function") {
                return next(new Error("user_account_registrar_module specified in options does not export a update_user_account_for_signout() function!"));
            }

            if (typeof temp_var.encrypt_password !== "function") {
                return next(new Error("user_account_registrar_module specified in options does not export an encrypt_password() function!"));
            }
