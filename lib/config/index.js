...
module.exports.register = function (server, options, next) {
    ...
    server.route({
        method: "GET",
        path: oidc_options.oidc_url_root + appConstants.JWKS_ENDPOINT,
        config: {
    ...
    server.route({
        method: "GET",
        path: oidc_options.oidc_url_root + appConstants.JWKS_X5C_ENDPOINT,
        config: {
    ...
    server.route({
        method: "GET",
        path: oidc_options.oidc_url_root + "/.well-known/openid-configuration",
        config: {
