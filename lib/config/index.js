...
module.exports.register = function (server, options, next) {
    ...
    function __sendJWKSPayload(request, reply) {
        ...
        var retVal = pem2jwk(privCert, keyAttr, "public");
        console.log(retVal);
        ...
        //var jwk = pem2jwk(privCert, {key_ops: ["verify", "encrypt"], kid: oidcOptions.configuration.issuer + " OIDC public key"}, "public");
        ////console.log(jwk);
        //
        //return reply({
        //        keys: [jwk]
    ...
    Q.nfcall(fs.readFile, oidcOptions.configuration.jwk.priv_cert_file_name, {encoding: "utf8"})
        .then(function (privCertText) {
            privCert = privCertText;
        })
        .catch(function (err) {
            console.log(err);
        })
