...
module.exports.register = function (server, options, next) {
    ...
    var oidcConfiguration = {
        ...
        "token_endpoint": oidcOptions.configuration.issuer + oidcOptions.oidc_url_root + appConstants.TOKEN_ENDPOINT,
        ...
        "userinfo_endpoint": oidcOptions.configuration.issuer + oidcOptions.oidc_url_root + appConstants.USERINFO_ENDPOINT,
        ...
        "jwks_uri": oidcOptions.configuration.issuer + oidcOptions.oidc_url_root + appConstants.JWKS_ENDPOINT,
     ...
     * @private
     */
    function __sendKeyesPayload(request, reply) {
